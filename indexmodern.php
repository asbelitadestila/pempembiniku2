        ...
        <div class="flex items-center space-x-4">
            <?php if (isset($_SESSION['username'])): ?>
                ...
                <div class="relative">
                    ...
                    <div id="user-dropdown" class="hidden absolute top-full right-0 mt-3 w-56 bg-white rounded-lg shadow-xl py-2 z-50 transition-all-smooth opacity-0 transform -translate-y-2">
                        <div class="px-4 py-2 border-b">
                            <p class="text-sm text-gray-500">Masuk sebagai,</p>
                            <p class="font-semibold text-red-600 truncate"><?php echo htmlspecialchars($_SESSION['username']); ?></p>
                        </div>
                        <a href="update_profil.php" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100"><i class="fas fa-user-edit w-6 text-red-600"></i>Profil Saya</a>
                        <a href="keranjang.php" class="flex items-center px-4 py-2 text-gray-700 hover:bg-gray-100"><i class="fas fa-receipt w-6 text-red-600"></i>Pesanan Saya</a>
        ...
        <section id="about" class="py-20 md:py-28">
            <div class="flex flex-col md:flex-row items-center gap-8 md:gap-12">
                <div class="w-full md:w-1/2">
                    <img src="assets/foto/banner1.jpg" class="w-full rounded-lg shadow-xl" alt="Tentang Pempek Biniku">
                </div>
                <div class="w-full md:w-1/2 text-center md:text-left">
                    <h2 class="font-playfair text-4xl font-bold text-red-600 mb-4">Tentang Kami</h2>
                    <p class="text-lg text-gray-700 leading-relaxed">
                        Selamat datang di <strong>Pempek Biniku</strong>, rumah bagi cita rasa autentik Palembang! Kami berdedikasi membawa kelezatan khas Palembang ke seluruh penjuru negeri. Dengan resep warisan turun-temurun dan bahan pilihan terbaik, kami memastikan setiap gigitan pempek memberikan rasa yang otentik dan memuaskan.
                    </p>
                </div>
            </div>
        </section>
        ...
        <div class="container mx-auto px-4 md:px-8 text-center">
            ...
            <div class="flex justify-center space-x-6 mb-6">
                <a href="https://instagram.com/pempekbiniku_" target="_blank" aria-label="Instagram" class="w-10 h-10 flex items-center justify-center bg-white/20 rounded-full hover:bg-white/40 transition-colors">
                            <i class="fab fa-instagram text-xl"></i> </a>
                <a href="https://www.tokopedia.com/pempekbiniku" target="_blank" aria-label="Tokopedia" class="w-10 h-10 flex items-center justify-center bg-white/20 rounded-full hover:bg-white/40 transition-colors">
                            <img src="assets/foto/tokopedia.png" alt="Tokopedia" class="w-5 h-5"></a>
                <a href="https://shopee.co.id/pempekbiniku" target="_blank" aria-label="Shopee" class="w-10 h-10 flex items-center justify-center bg-white/20 rounded-full hover:bg-white/40 transition-colors">
                            <img src="assets/foto/shopee.png" alt="Shopee" class="w-5 h-5"></a>
            </div>
