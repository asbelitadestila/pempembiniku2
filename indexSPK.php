...
<body class="bg-[#FFFAE7] text-gray-800">
        ...
        <div id="user-dropdown" 
            ...
            <div class="py-1" role="none">
                ...
                <div class="flex items-center px-4 py-3 border-b border-gray-200">
                    <div class="flex-shrink-0 h-10 w-10 rounded-full bg-red-600 text-white flex items-center justify-center font-bold text-lg">
                        <?php 
                ...
                <div class="py-2" role="none">
                    <a href="profil.php" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 transition-colors" role="menuitem">
                        <i class="fas fa-user-edit w-6 text-gray-500"></i>
                        <span>Profil Saya</span>
                    </a>
                    <a href="keranjang.php" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 transition-colors" role="menuitem">
                ...
                <a href="admin/logout.php" class="flex items-center px-4 py-2 text-sm text-red-600 hover:bg-red-50 hover:font-semibold transition-all duration-150" role="menuitem">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            window.addEventListener('click', function (event) {
                if (!dropdown.classList.contains('hidden') && !menuButton.contains(event.target)) {
                    dropdown.classList.remove('opacity-100', 'scale-100');
                    dropdown.classList.add('opacity-0', 'scale-95');
                    setTimeout(() => {
                        dropdown.classList.add('hidden');
            ...
            <?php else: ?>
                <div class="hidden sm:flex items-center space-x-2">
                    <a href="admin/login.php" class="bg-white text-red-600 px-5 py-2 rounded-full font-semibold hover:bg-gray-200 transition-all-smooth text-sm">Login</a>
                    <a href="daftar.php" class="border-2 border-white text-white px-5 py-2 rounded-full font-semibold hover:bg-white hover:text-red-600 transition-all-smooth text-sm">Daftar</a>
                </div>
            <?php endif; ?>
    ...
    <!-- Mobile Menu -->
    <div id="mobile-menu" class="hidden lg:hidden fixed top-0 left-0 w-full h-full bg-red-700 z-40 p-8 text-center space-y-6">
        ...
        <?php if (!isset($_SESSION['username'])): ?>
        <div class="pt-6">
            <a href="admin/login.php" class="bg-white text-red-600 px-8 py-3 rounded-full font-semibold hover:bg-gray-200 transition-all-smooth">Login</a>
        </div>
        <?php endif; ?>
    </div>
    ...
    <section id="home" class="relative w-full h-screen overflow-hidden">
        ...
        <!-- Carousel Controls -->
        <button id="prev-btn" class="absolute top-1/2 left-4 transform -translate-y-1/2 z-10 text-white bg-black/30 w-12 h-12 rounded-full hover:bg-black/50 transition-all-smooth"><i class="fas fa-chevron-left"></i></button>
        <button id="next-btn" class="absolute top-1/2 right-4 transform -translate-y-1/2 z-10 text-white bg-black/30 w-12 h-12 rounded-full hover:bg-black/50 transition-all-smooth"><i class="fas fa-chevron-right"></i></button>
    </section>
     ...
     <!-- <div class="absolute top-0 left-0 h-full w-[55%] bg-[#F9F6F3] rounded-tr-[250px] rounded-br-[250px]"></div> -->
        ...
        <div class="relative container mx-auto px-12 flex items-center z-10">
         ...
         <div class="w-1/2 pr-16">
            ...
            <p class="text-gray-500 mb-10 text-base leading-relaxed">
              Satu gigitan pempek kami akan membawa Anda pada perjalanan rasa tak terlupakan, memadukan tradisi Palembang dengan sentuhan modern yang unik dan istimewa.
            </p>
            
            <button class="bg-red-600 text-white font-semibold uppercase tracking-widest px-10 py-3 rounded-full hover:bg-red-700 transition duration-300 ease-in-out shadow-md hover:shadow-lg">
              Selengkapnya
            </button>
        </div>
        ...
        <section id="featured-products" class="py-20 md:py-28 text-center bg-white rounded-lg shadow-xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="group">
                    <div class="relative">
                        <img src="assets/foto_produk/<?php echo htmlspecialchars($value['foto_produk']); ?>" class="w-full h-64 object-cover rounded-lg shadow-md" alt="<?php echo htmlspecialchars($value['nama_produk']); ?>">
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mt-4"><?php echo htmlspecialchars($value['nama_produk']); ?></h3>
                    <p class="text-lg font-semibold text-red-600">Rp <?php echo number_format($value['harga_produk']); ?></p>
                    <a href="index.php#produk" class="inline-block mt-4 bg-red-600 text-white py-2 px-6 rounded-lg font-semibold hover:bg-red-700 transition-all-smooth">
                        Lihat Detail
                    </a>
                </div>
                <?php endforeach; ?>
        ...
        <section id="produk" class="py-20 md:py-28 text-center">
            ...
            <p class="max-w-2xl mx-auto text-gray-600 mb-12">Jelajahi berbagai pilihan pempek kami, dari satuan hingga paket lengkap.</p>
                ...
                <div class="produk-item group" data-kategori="<?php echo strtolower(htmlspecialchars($value['nama_kategori'])); ?>">
                    <form action="index.php#produk" method="post" class="bg-white rounded-lg shadow-lg h-full flex flex-col overflow-hidden transition-all-smooth transform hover:-translate-y-2 hover:shadow-2xl">
                        ...
                        <div class="p-5 flex flex-col flex-grow">
                            <h3 class="text-lg font-bold text-gray-800"><?php echo htmlspecialchars($value['nama_produk']); ?></h3>
                            <p class="text-sm text-gray-500 mb-2">Stok: <?php echo number_format($value['stok_produk']); ?></p>
                            <p class="text-xl font-bold text-red-600 my-2">Rp <?php echo number_format($value['harga_produk']); ?></p>
                            
                            <div class="mt-auto pt-4">
                                <!-- Hidden fields -->
                                <input type="hidden" name="id_produk" value="<?php echo $value['id_produk']; ?>">
                                <input type="hidden" name="nama_produk" value="<?php echo htmlspecialchars($value['nama_produk']); ?>">
                                <input type="hidden" name="harga_produk" value="<?php echo $value['harga_produk']; ?>">
                                <input type="hidden" name="foto_produk" value="<?php echo htmlspecialchars($value['foto_produk']); ?>">
    ...
    <section id="kontak" class="py-20 md:py-28 bg-white">
        <div class="container mx-auto px-4 md:px-8 text-center">
            ...
            <p class="max-w-2xl mx-auto text-gray-600 mb-12">Temukan lokasi kami atau hubungi kami melalui media sosial.</p>
            <div class="rounded-lg overflow-hidden shadow-xl">
                <iframe class="w-full h-96" src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d16335807.982538566!2d92.02327591828396!3d-1.6145300000000005!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMcKwMzYnNTIuMyJTIDEwM8KwMzcnMzAuMSJF!5e0!3m2!1sen!2sid!4v1724488443830!5m2!1sen!2sid" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
    </section>
    ...
    <footer class="bg-red-700 text-white py-10">
        <div class="container mx-auto px-4 md:px-8 text-center">
            ...
            <div class="flex justify-center space-x-6 mb-6">
                <a href="https://instagram.com/pempekbiniku_" target="_blank" aria-label="Instagram" class="w-10 h-10 flex items-center justify-center bg-white/20 rounded-full hover:bg-white/40 transition-colors">
                    <i class="fab fa-instagram text-xl"></i>
                </a>
                <a href="https://www.tokopedia.com/pempekbiniku" target="_blank" aria-label="Tokopedia" class="w-10 h-10 flex items-center justify-center bg-white/20 rounded-full hover:bg-white/40 transition-colors">
                    <img src="assets/foto/tokopedia.png" alt="Tokopedia" class="w-5 h-5">
                </a>
                <a href="https://shopee.co.id/pempekbiniku" target="_blank" aria-label="Shopee" class="w-10 h-10 flex items-center justify-center bg-white/20 rounded-full hover:bg-white/40 transition-colors">
