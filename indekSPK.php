...
<head>
    ...
    <style>
        /* ========================================
         PALET WARNA MODERN & PENGATURAN DASAR
         Ubah warna di sini untuk mengubah tema website.
         ======================================== */
        :root {
            --bg-main: #FDFBF5;       /* Krem Hangat */
            --text-dark: #2C2A2A;     /* Arang Gelap (Premium) */
            --text-light: #6B6B6B;    /* Abu-abu Lembut */
            --accent: #E87A00;        /* Oranye Keemasan (Cuko) */
            --accent-hover: #D06C00;  /* Oranye lebih gelap untuk hover */
